...
def render() -> str:
    ...
    out = [
        ...
        "    `tests/unit/test_config.py::test_no_field_points_at_a_network` is what keeps it",
        "    that way. All networking lives in the constructor of a step somebody wrote",
        "    by hand — see [ADR 0001](adr/index.md#0001-no-networking-in-the-default-cascade).",
        "",
        "```python",
